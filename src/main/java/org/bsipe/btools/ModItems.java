...
public class ModItems {
    ...
    public static Item NETHERITE_AXE = register( new AxeItem( ToolMaterials.NETHERITE, new Item.Settings().maxCount(1).component(DataComponentTypes.CUSTOM_DATA, getDefaultSprite( "netherite_axe" ) ).fireproof().attributeModifiers(AxeItem.createAttributeModifiers(ToolMaterials.NETHERITE, 5.0F, -3.0F))), "netherite_axe" );
    public static Item NETHERITE_PICKAXE = register( new PickaxeItem( ToolMaterials.NETHERITE, new Item.Settings().maxCount(1).component(DataComponentTypes.CUSTOM_DATA, getDefaultSprite( "netherite_pickaxe" ) ).fireproof().attributeModifiers(PickaxeItem.createAttributeModifiers(ToolMaterials.NETHERITE, 1.0F, -2.8F))), "netherite_pickaxe" );
    public static Item NETHERITE_HOE = register( new HoeItem( ToolMaterials.NETHERITE, new Item.Settings().maxCount(1).component(DataComponentTypes.CUSTOM_DATA, getDefaultSprite( "netherite_hoe" ) ).fireproof().attributeModifiers(HoeItem.createAttributeModifiers(ToolMaterials.NETHERITE, -4.0F, 0.0F))), "netherite_hoe" );
    public static Item NETHERITE_SHOVEL = register( new ShovelItem(ToolMaterials.NETHERITE, new Item.Settings().maxCount(1).component(DataComponentTypes.CUSTOM_DATA, getDefaultSprite( "netherite_shovel" ) ).fireproof().attributeModifiers(ShovelItem.createAttributeModifiers(ToolMaterials.NETHERITE, 1.5F, -3.0F))), "netherite_shovel" );
    public static Item NETHERITE_SWORD = register( new SwordItem( ToolMaterials.NETHERITE, new Item.Settings().maxCount(1).component(DataComponentTypes.CUSTOM_DATA, getDefaultSprite( "netherite_sword" ) ).fireproof().attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.NETHERITE, 3, -2.4F))), "netherite_sword" );
