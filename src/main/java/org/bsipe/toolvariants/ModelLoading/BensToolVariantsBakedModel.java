...
public class BensToolVariantsBakedModel implements BakedModel, FabricBakedModel, UnbakedModel {
    ...
    public BensToolVariantsBakedModel()  {
    }
    ...
    public Sprite getParticleSprite() {
        return TEXTURE_GETTER.apply( new SpriteIdentifier( SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE, Identifier.of( "tool-variants","item/oak_tool_handle")));
    }
