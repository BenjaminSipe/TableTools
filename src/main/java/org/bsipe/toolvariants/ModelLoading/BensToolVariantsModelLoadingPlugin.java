...
public class BensToolVariantsModelLoadingPlugin implements ModelLoadingPlugin {
    ...
    private static BensToolVariantsBakedModel modelBaker = new BensToolVariantsBakedModel();
