...
import org.bsipe.toolvariants.enums.HandleMaterialsEnum;
import org.bsipe.toolvariants.enums.HeadMaterialsEnum;

public class ToolVariantCraftingRecipe implements CraftingRecipe {
    ...
    public ToolVariantCraftingRecipe(ComponentEnum toolType, Ingredient headIngredient, Ingredient handleIngredient, ItemStack result) {
    ...
    public static class Serializer implements RecipeSerializer<ToolVariantCraftingRecipe> {

        public static final Serializer INSTANCE = new Serializer();
        public static final String ID = "tool_variant_crafting";

        public static final MapCodec<ToolVariantCraftingRecipe> CODEC = RecordCodecBuilder.mapCodec(
                in -> in.group(
                ...
                ).apply(in, ToolVariantCraftingRecipe::new));


        @Override
        public MapCodec<ToolVariantCraftingRecipe> codec() {
            return CODEC;
        }

        @Override
        public PacketCodec<RegistryByteBuf, ToolVariantCraftingRecipe> packetCodec() {
            return PACKET_CODEC;
        }

        public static final PacketCodec<RegistryByteBuf, ToolVariantCraftingRecipe> PACKET_CODEC = PacketCodec.ofStatic(
                ToolVariantCraftingRecipe.Serializer::write, ToolVariantCraftingRecipe.Serializer::read
        );

        private static ToolVariantCraftingRecipe read(RegistryByteBuf buf) {
            ...
            return new ToolVariantCraftingRecipe( component, headIngredient, handleIngredient, result );
        }

        private static void write(RegistryByteBuf buf, ToolVariantCraftingRecipe recipe) {
