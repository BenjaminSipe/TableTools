...
import static org.bsipe.toolvariants.BensToolVariants.MOD_ID;

public class ToolVariantItems {
    ...
    public static final TagKey<Item> TOOL_HANDLES = TagKey.of( RegistryKeys.ITEM, Identifier.of( BensToolVariantsDataGenerator.MOD_ID, "tool_handles" ) );
